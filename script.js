document.addEventListener("DOMContentLoaded", function () {
    ...
    document.getElementById('coupleNames').textContent = getQueryParameter('couple') || 'Alwi & Fatimah';
    ...
    function calculateCountdown() {
        const weddingDate = new Date('2025-01-09T12:30:00');
    ...
    function loadMessages() {
        fetch('https://alwi-fatimah.glitch.me/messages')
